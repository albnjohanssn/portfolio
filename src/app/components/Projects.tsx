const posts = [
    {
        ...
        description:
            'My first attempt to create an interactive 3D application in Next.Js.',
        imageUrl:
            '/3d-app.png',
        date: 'April 09, 2025',
        datetime: '2025-04-09',
        ...
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl text-center">
                    ...
                    <p className="mt-2 text-lg/8 text-gray-600">This is a list of some of my projects.</p>
                </div>
                <div className="mx-auto mt-16 grid max-w-2xl auto-rows-fr grid-cols-1 gap-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {posts.map((post) => (
                        ...
                        >
                            ...
                            <h3 className="mt-3 text-lg/6 font-medium text-black">
                                <a href={post.href}>
